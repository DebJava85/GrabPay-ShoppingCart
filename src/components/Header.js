        ...
        return(
            <header>
                <div className="container">
                    <div className="brand">
                        <img className="logo" src="https://res.cloudinary.com/debray/image/upload/v1530587692/images.png" height="60" width="90" alt="megamart-logo"/>
                    </div>
                    ...
                    <div className="search">
                        ...
                        <form action="#" method="get" className={this.state.mobileSearch ? "search-form active" : "search-form"}>
                            ...
                            <input type="search" ref="searchBox" placeholder="Search for clothes" className="search-keyword" onChange={this.props.handleSearch}/>
